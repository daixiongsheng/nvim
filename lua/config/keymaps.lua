...
-- vim.api.nvim_set_keymap("n", "J", "10gj", { noremap = false })
-- vim.api.nvim_set_keymap("n", "K", "10gk", { noremap = false }  )
-- vim.api.nvim_set_keymap("v", "J", "10gj", { noremap = false })
-- vim.api.nvim_set_keymap("v", "K", "10gk", { noremap = false } )

-- vim.keymap.set("n", "j", "v:count == 0 ? 'gj' : 'j'", { expr = true, silent = true })
-- vim.keymap.set("n", "k", "v:count == 0 ? 'gk' : 'k'", { expr = true, silent = true })
-- vim.keymap.set("n", "J", "v:count == 0 ? '10gj' : '10j'", { expr = true, silent = true })
-- vim.keymap.set("n", "K", "v:count == 0 ? '10gk' : '10k'", { expr = true, silent = true })
...
map("n", "<a-m>", "<cmd>Neotree<cr>" )
map("v", "<a-m>", "<cmd>Neotree<cr>" )
